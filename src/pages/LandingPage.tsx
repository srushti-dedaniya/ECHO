        ...
        <div className="max-w-7xl mx-auto pointer-events-auto flex items-center justify-between">
          ...
          {isAuthenticated && (
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-space-md py-space-sm rounded-full bg-secondary-container text-on-secondary-container font-label-sm text-label-sm hover:bg-secondary transition-all"
              type="button"
            >
              Logout (Dev)
            </motion.button>
